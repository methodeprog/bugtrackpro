...
<head>
    ...
    <title>Blur Admin - Sign Up</title>
...
<body>
    <main class="auth-main">
        <div class="auth-block">
            ...
            <a href="<?= site_url('auth/login') ?>" class="auth-link">Already have a Blur Admin account? Sign in!</a>
            ...
            <form class="form-horizontal" action="<?= site_url('auth/register') ?>" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="username" class="form-control" id="inputName3" placeholder="Username" required>
                    </div>
                </div>
